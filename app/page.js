    ...
    <main className="flex gap-2">
      <header className="w-full p-4 flex justify-center">
        ...
        <div className="flex gap-2">
          <button className="p-2 rounded-full bg-[#2C2C2C] flex justify-center items-center">
            <svg
              className="scale-75"
          ...
          <div
            className={`${permanent_Marker.className} p-2 rounded-full bg-[#2C2C2C] flex gap-4`}
          >
