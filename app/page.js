...
import SBUs from "./components/PEG";
...
export default function Home() {
  ...
  return (
    <main className="relative flex flex-col gap-2">
      ...
      {/* SBUs Section */}
      <main className="px-14 py-8 w-full min-h-screen flex justify-between items-center gap-20 scroll-snap-y">
        <ScrollSnap />
              ...
              {legendexp ? (
                <div>
                  ...
                  <p className="text-lg text-[#DDDDDD]">
                    ...
                    call of duty, creating benchmarks of excellence that inspire
